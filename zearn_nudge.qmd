...
We attributed this pronounced effect to two key factors. First, Friday logins facilitate "Reflective Catch-Up," enabling teachers to review and analyze the previous week's activities and make necessary adjustments. Second, "Foresighted Planning" occurs on Fridays as teachers proactively plan for the upcoming week, a practice less common on weekends.
...
To promote transparency and replicability of our study, we have deposited the data and code used in our analyses in a publicly accessible database, available at the GitHub repository: <https://github.com/SeanHu0727/zearn_nudge.git>
